...
enum SearchEngineType {
  ...
  SEARCH_ENGINE_AMAZON,
  SEARCH_ENGINE_GITHUB,
  SEARCH_ENGINE_STACKOVERFLOW,
  SEARCH_ENGINE_MDN,
  SEARCH_ENGINE_TWITTER,
  SEARCH_ENGINE_WIKIPEDIA,
  SEARCH_ENGINE_YOUTUBE,
  SEARCH_ENGINE_STARTPAGE,
  SEARCH_ENGINE_INFOGALACTIC,
  SEARCH_ENGINE_WOLFRAMALPHA,
  SEARCH_ENGINE_SEMANTICSCHOLAR,
  SEARCH_ENGINE_QWANT          // Bounding value needed for UMA histogram macro.
};
