...
const PrepopulatedEngine* engines_default[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo, &yandex, };

// United Arab Emirates
const PrepopulatedEngine* engines_AE[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_maktoob, &yandex,  };
...
const PrepopulatedEngine* engines_AR[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_ar, &yandex, };

// Austria
const PrepopulatedEngine* engines_AT[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_at, &yandex, };

// Australia
const PrepopulatedEngine* engines_AU[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_au, &yandex, };
...
const PrepopulatedEngine* engines_BE[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo, &yahoo_fr, &yandex, };

// Bulgaria
const PrepopulatedEngine* engines_BG[] =
    { &google, &amazon, &ask, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo, &yandex, };
...
const PrepopulatedEngine* engines_BN[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_my, &yandex, };
...
const PrepopulatedEngine* engines_BR[] =
    { &google, &amazon, &ask_br, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube,  &yahoo_br, &yandex, };

// Belarus
const PrepopulatedEngine* engines_BY[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mail_ru, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo, &yandex_by, };
...
const PrepopulatedEngine* engines_CA[] =
    { &google, &amazon, &ask, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_ca, &yahoo_qc, &yandex, };

// Switzerland
const PrepopulatedEngine* engines_CH[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_ch, &yandex, };

// Chile
const PrepopulatedEngine* engines_CL[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_cl, &yandex, };

// China
const PrepopulatedEngine* engines_CN[] =
    { &google, &amazon, &baidu, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &sogou, &so_360, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo, &yandex, };

// Colombia
const PrepopulatedEngine* engines_CO[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_co, &yandex, };
...
const PrepopulatedEngine* engines_CZ[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &seznam, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yandex, };

// Germany
const PrepopulatedEngine* engines_DE[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_de, &yandex, };

// Denmark
const PrepopulatedEngine* engines_DK[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_dk, &yandex, };
...
const PrepopulatedEngine* engines_ES[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_es, &yandex, };

// Faroe Islands
const PrepopulatedEngine* engines_FO[] =
    { &google, &amazon, &ask, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yandex, };

// Finland
const PrepopulatedEngine* engines_FI[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_fi, &yandex, };

// France
const PrepopulatedEngine* engines_FR[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_fr, &yandex, };

// United Kingdom
const PrepopulatedEngine* engines_GB[] =
    { &google, &amazon, &ask_uk, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_uk, &yandex, };

// Greece
const PrepopulatedEngine* engines_GR[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_gr, &yandex, };
...
const PrepopulatedEngine* engines_HK[] =
    { &google, &amazon, &baidu, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_hk, &yandex, };
...
const PrepopulatedEngine* engines_ID[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_id, &yandex, };

// Ireland
const PrepopulatedEngine* engines_IE[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_uk, &yandex, };
...
const PrepopulatedEngine* engines_IN[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_in, &yandex, };
...
const PrepopulatedEngine* engines_IT[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &virgilio, &wikipedia, &wolframalpha, &youtube, &yahoo, &yandex, };
...
const PrepopulatedEngine* engines_JP[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_jp, &yandex, };
...
const PrepopulatedEngine* engines_KR[] =
    { &google, &amazon, &bing, &daum, &duckduckgo, &ecosia, &github, &infogalactic, &naver, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yandex, };

// Kazakhstan
const PrepopulatedEngine* engines_KZ[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &mail_ru, &yahoo, &yandex_kz, };
...
const PrepopulatedEngine* engines_LT[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo, &yandex_ru, };
...
const PrepopulatedEngine* engines_MX[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_mx, &yandex, };
...
const PrepopulatedEngine* engines_NL[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &vinden, &wikipedia, &wolframalpha, &youtube, &yahoo_nl, &yandex, };

// Norway
const PrepopulatedEngine* engines_NO[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &kvasir, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo, &yandex, };

// New Zealand
const PrepopulatedEngine* engines_NZ[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_nz, &yandex, };
...
const PrepopulatedEngine* engines_PE[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_pe, &yandex, };

// Philippines
const PrepopulatedEngine* engines_PH[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_ph, &yandex, };
...
const PrepopulatedEngine* engines_PL[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &onet, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo, &yandex, };
...
const PrepopulatedEngine* engines_RO[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_ro, &yandex, };
...
const PrepopulatedEngine* engines_RU[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mail_ru, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo, &yandex_ru, };
...
const PrepopulatedEngine* engines_SE[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_se, &yandex, };

// Singapore
const PrepopulatedEngine* engines_SG[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_sg, &yandex, };

// Slovenia
const PrepopulatedEngine* engines_SI[] =
    { &google, &amazon, &ask, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &najdi, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo, &yandex, };
...
const PrepopulatedEngine* engines_TH[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_th, &yandex, };
...
const PrepopulatedEngine* engines_TR[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_tr, &yandex_tr, &yandex, };
...
const PrepopulatedEngine* engines_TW[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_tw, &yandex, };
...
const PrepopulatedEngine* engines_UA[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo, &yandex_ua, };

// United States
const PrepopulatedEngine* engines_US[] =
    { &google, &amazon, &aol, &ask, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo, &yandex, };
...
const PrepopulatedEngine* engines_VE[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_ve, &yandex, };

// Vietnam
const PrepopulatedEngine* engines_VN[] =
    { &google, &amazon, &bing, &duckduckgo, &ecosia, &github, &infogalactic, &mdn, &qwant, &semanticscholar, &stackoverflow, &startpage, &twitter, &wikipedia, &wolframalpha, &youtube, &yahoo_vn, &yandex, };
