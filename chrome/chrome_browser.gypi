...

{
  'variables': {
    ...
    'chrome_browser_net_sources': [
      ...
      'browser/net/blockers/blockers_worker.h',
      'browser/net/blockers/blockers_worker.cc',
      'browser/net/blockers/ABPFilterParser.h',
      'browser/net/blockers/ABPFilterParser.cpp',
      'browser/net/blockers/badFingerprint.h',
      'browser/net/blockers/badFingerprints.h',
      'browser/net/blockers/base.h',
      'browser/net/blockers/BloomFilter.h',
      'browser/net/blockers/BloomFilter.cpp',
      'browser/net/blockers/cosmeticFilter.h',
      'browser/net/blockers/cosmeticFilter.cpp',
      'browser/net/blockers/filter.h',
      'browser/net/blockers/filter.cpp',
      'browser/net/blockers/FirstPartyHost.h',
      'browser/net/blockers/hashFn.h',
      'browser/net/blockers/hashFn.cpp',
      'browser/net/blockers/HashItem.h',
      'browser/net/blockers/HashSet.h',
      'browser/net/blockers/HashSet.cpp',
